...
function useDonorSignUpWithEmailAndPassword() {
        ...
        if(newUser) {
            ...
            const userCreationPromise = new Promise(async (resolve, reject) => {
                try{
                    ...
                    const pastorDocRef = doc(collection(db, "pastorsUsers"));
                    ...
                    const churchDocRef = doc(collection(db, "churchesUsers"));
...
export default useDonorSignUpWithEmailAndPassword;